...
import com.graduate.touslestemp.exception.BadRequestException;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	protected String determineTargetUrl(jakarta.servlet.http.HttpServletRequest request, jakarta.servlet.http.HttpServletResponse response, Authentication authentication) {
		Optional<String> redirectUri = CookieUtils.getCookie((HttpServletRequest) request, REDIRECT_URI_PARAM_COOKIE_NAME).map(Cookie::getValue);
